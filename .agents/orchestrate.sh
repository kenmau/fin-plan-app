...
#   Set models:       .agents/orchestrate.sh --generator-model claude-sonnet-4-20250514 --validator-model claude-opus-4-20250514 FIN-36
#   Via env vars:     GENERATOR_MODEL=claude-opus-4-20250514 .agents/orchestrate.sh FIN-36
#
# Prerequisites:
...
**Models:** Generator: \`$GENERATOR_MODEL\` | Validator: \`$VALIDATOR_MODEL\`"
